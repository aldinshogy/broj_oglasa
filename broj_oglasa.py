...
# Ulaz: Datum registracije (bez predefinisanog datuma)
datum_registracije = st.date_input(
    "Odaberi datum registracije:",
    value=None,  # Nema predefinisan datum
    min_value=datetime(2000, 1, 1),
    max_value=datetime.today()
)

# Provjeri da li je datum odabran
if datum_registracije is not None:
    # Trenutni datum
    ...
    st.write("👆 Molimo odaberite datum registracije da biste vidjeli rezultat.")
